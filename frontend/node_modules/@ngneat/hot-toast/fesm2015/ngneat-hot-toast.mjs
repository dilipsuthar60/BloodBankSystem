...
class HotToastService {
    ...
    info(message, options) {
        var _a;
        const toast = this.createToast(message || this._defaultConfig.info.content, 'info', Object.assign(Object.assign(Object.assign({}, this._defaultConfig), (_a = this._defaultConfig) === null || _a === void 0 ? void 0 : _a.info), options));
        return toast;
    }
    /**
     *
    ...
    observe(messages) {
        return (source) => {
            ...
            let toastRef;
            let start = 0;
            const loadingContent = (_a = messages.loading) !== null && _a !== void 0 ? _a : (_b = this._defaultConfig.loading) === null || _b === void 0 ? void 0 : _b.content;
            const successContent = (_c = messages.success) !== null && _c !== void 0 ? _c : (_d = this._defaultConfig.success) === null || _d === void 0 ? void 0 : _d.content;
            const errorContent = (_e = messages.error) !== null && _e !== void 0 ? _e : (_f = this._defaultConfig.error) === null || _f === void 0 ? void 0 : _f.content;
            return defer(() => {
                if (loadingContent) {
                    toastRef = this.createLoadingToast(loadingContent);
                    start = Date.now();
                }
                return source.pipe(tap(Object.assign(Object.assign({}, (successContent && {
                    next: (val) => {
    ...
    getContentAndOptions(toastType, message) {
        ...
        if (typeof message === 'string' || isTemplateRef(message) || isComponent(message)) {
            ...
            let restOptions;
            (({ content } = message), restOptions = __rest(message, ["content"]));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.1", ngImport: i0, type: HotToastService, decorators: [{
        ...
        return [{ type: i1$1.ViewService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [PLATFORM_ID]
